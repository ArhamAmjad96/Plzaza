...
import { ActivityLogItem, ActivityCategory } from @/lib/logs/service;
...
export default function AuditLogManager({
 ...
 return /settings;
 case UNITS:
 return log.metadata?.unitNumber ? /units/ : /units;
 case TENANTS:
 return /tenants;
 case PAYMENTS:
 return /rent;
 ...
 <span className={px-2.5 py-0.5 rounded-full border text-[10px] font-bold font-mono uppercase tracking-wider }>
 {log.category}
 </span>

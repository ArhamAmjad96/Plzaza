...
import { markNotificationsAsReadAction, getNotificationsAction } from "@/app/logs/actions";
            ...
            {notifications.length === 0 ? (
              ...
              notifications.map((notif) => (
                <Link
                  ...
                  className={`block p-4 transition hover:bg-[#E8EDD9]/60 ${
                    !notif.read ? "bg-[#FAF6F0] border-l-4 border-l-[#FF704D]" : "bg-[#FAF6F0]/60 opacity-80"
                  }`}
                >
